"""A maitenance script for adding missing "follows" relations to preprint/postprints."""
...
def main(non_interactive: bool):
    """Add missing "follows" relationships for preprint/postprint relations."""
    lines = [
        EntityLine(
    ...
    if non_interactive:
        client.post(lines, batch_name="Preprint Maitenance")
    else:
